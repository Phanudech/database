...
<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">ใบแจ้งชําระเงิน </h4><br>
                  <h4 class="card-title ">Room ID : <?php echo $Room_No; ?> </h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <?php
                        $i = 0;
                        $sql = "SELECT * FROM (payment JOIN slipnumber ON payment.Pay_No = slipnumber.Pay_No) JOIN pay_status ON payment.Pay_Status = pay_status.pay_id WHERE Room_No = $Room_No ORDER BY payment.Pay_No DESC";
                            ...
                            <tr>
                                ...
                                <?php if($row['Pay_Status'] == 1){?>
                                    <td style="text-align:right;">
                                        <a href="customer_payment_payfor.php?pay_no=<?php echo $row['Pay_No']; ?>">
                                            <button type="button" class="btn btn-outline-primary btn-sm">ชําระเงิน</button></td>
                                        </a> </td>
                                <?php }else if($row['Pay_Status'] == 2){?>
                                    <td style="text-align:right;">
                                <?php }else if($row['Pay_Status'] == 3){?>
