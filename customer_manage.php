                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <h6 class="f-w-600"><?php echo $_SESSION['Cus_name'].' '.$_SESSION['Cus_lastname']; ?></h6>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><?php echo $_SESSION['Cus_Email']; ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <h6 class="text-muted f-w-400"><?php echo $_SESSION['Road']; ?></h6>
                                    </div>
                                    <div class="col-sm-4">
                                        <p class="m-b-10 f-w-600">District</p>
                                        <h6 class="text-muted f-w-400"><?php echo $_SESSION['District']; ?></h6>
                                    </div>
                                    <div class="col-sm-4">
                                        <p class="m-b-10 f-w-600">Province</p>
                                        <h6 class="text-muted f-w-400"><?php echo $_SESSION['Province']; ?></h6>
                                    </div>
                                </div>
                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Room No.</h6>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <p class="m-b-10 f-w-600"></p>
                                        <h6 class="text-muted f-w-400">
                                            <p style="font-size:50px;"><?php echo $_SESSION['Room_No']; ?></p>
                                        </h6>
                                    </div>
                                </div>
                            </div>
          ...
          <div class="card-body cleartfix">
            <div class="media align-items-stretch">
              ...
              <div class="media-body">
                <h4>Payment</h4>
                <?php $Room_No = $_SESSION['Room_No']; ?>
                <a href="customer_payment.php?Room_No=<?php echo $Room_No; ?>">
