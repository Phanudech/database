...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><input type='text' name="AmountDue" value=0 readonly id='amount'> บาท</td>
                        </tr>
                    </tfoot>
                </table>
            </main>
        ...
        <p><input type='submit' class="w3-button w3-blue w3-xlarge" id='create_btn' value="สร้างใบเเจ้งชําระเงิน"></p>
        <div></div>
